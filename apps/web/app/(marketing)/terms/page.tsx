    ...
    <div className="container max-w-3xl space-y-8 py-16">
      ...
      <section className="space-y-3">
        ...
        <p className="text-muted-foreground">
          Growth Agent connects to accounts and websites you own or are authorized to manage — YouTube,
          TikTok, Google Search Console, and websites you verify ownership of — and produces analysis,
          recommendations, and generated content based on the data those sources return.
        </p>
      </section>
      ...
      <section className="space-y-3">
        ...
        <p className="text-muted-foreground">
          ...
          rankings. Recommendations are explainable and grounded in the data available at the time they
          were generated, but outcomes on YouTube, TikTok, Google, or any other third-party platform are
          determined solely by that platform.
        </p>
      </section>
      ...
      <section className="space-y-3">
        ...
        <ul className="text-muted-foreground list-disc space-y-1.5 pl-5">
          ...
          <li>You must not use the service to crawl or access websites you don&apos;t own or control.</li>
        </ul>
      </section>
      ...
      <section className="space-y-3">
        ...
        <p className="text-muted-foreground">
          Paid plans are billed through our payment processor on the cycle you select at checkout. Usage
          limits for each plan are shown on the Pricing page and enforced automatically; exceeding a
          limit may require an upgrade to continue that specific action.
        </p>
      </section>
      ...
      <section className="space-y-3">
        ...
        <p className="text-muted-foreground">
          You may delete your account or organization at any time from Settings. We may suspend access
          for activity that violates these terms, including unauthorized crawling or attempts to bypass
          usage limits.
        </p>
      </section>
